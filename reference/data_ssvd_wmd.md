...
Process marriage data downloaded from the UN Population Division's
[World Marriage
...
``` r
data_ssvd_wmd(file, n_comp = 5, status = c("current", "ever"), eps = 1e-05)
```
...
Go to to page [World Marriage
Data](https://www.un.org/development/desa/pd/data/world-marriage-data).
Go to the data tab on the right. Download the most recent excel
spreadsheet (which as of October 2025 is called
...
## coef_wmd Truncation and transformation
