...
## HAS_TESTS
#' Tidy Data Frame Containing Labor Force Participation Data
#'
#' @param data A data frame
#'
#' @returns A tibble.
...
lfp_tidy <- function(data) {
  ...
  names(ans) <- c("time", "country", "sex", "age", "measure")
